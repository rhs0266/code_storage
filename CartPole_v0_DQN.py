'''
source : https://github.com/lbbc1117/ClassicControlDQN/blob/master/cart_pole.py
...
def train(env):
    ...
    for i_episode in xrange(options.MAX_EPISODE):
        ...
        observation = env.reset() # observation = [x, theta, dx/dt, dtheta/dt]
        done = False
        score = 0
        sum_loss_value = 0
        ...
        if learning_finished or i_episode % 100 == 0:
